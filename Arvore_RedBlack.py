...
class Arvore_RedBlack(ArvoreAVL):    
    ...
    def verificar_cor_no(self, node_father: Celula, node_add: Celula):
        if node_add.color == 'Vermelho' and node_father.color == 'Vermelho': node_add.color = Color.PRETO
...
def executa_avl1():
    ...
    avl1.adicionar(avl1.found_index_node('27') , Celula(None, None, '15', Direction.ESQUERDA, Color.PRETO))
    ...
    avl1.adicionar(avl1.found_index_node('29'), Celula(None, None, '13', Direction.DIREITA, Color.PRETO))
